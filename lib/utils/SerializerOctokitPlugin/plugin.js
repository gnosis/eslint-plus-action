...
const SerializerOctokitPlugin = (octokit, clientOptions) => {
    const { data } = clientOptions.serializer;
    const match = clientOptions.serializer.routes
        ? (0, routeMatcher_1.requestRouteMatcher)(clientOptions.serializer.routes)
        : undefined;
    if (clientOptions.serializer.enabled !== false &&
        ...
        octokit.hook.wrap('request', (request, requestOptions) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
                    ...
                    for (const artifact of issueArtifacts) {
                        ...
                        try {
                            ...
                            for (const [route, descriptor] of requests) {
                                ...
                                yield (0, issues_1.handleIssueComment)(octokit, data);
                                yield (0, artifacts_1.updateIssueState)(octokit, data);
                                yield (0, artifacts_1.deleteArtifactByName)(octokit, (0, utils_1.getIssueLintResultsName)(data));
                            }
                        }
                        catch (err) {
...
exports.SerializerOctokitPlugin = SerializerOctokitPlugin;
