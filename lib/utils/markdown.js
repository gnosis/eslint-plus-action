...
function getLintAnnotation(annotation, data) {
    return (0, dedent_1.default) `- ${getAnnotationFileLink(annotation, data)} ${getAnnotationFileLine(annotation)} - ${annotation.message}${data.issueSummaryType === 'full' ? getAnnotationSuggestions(annotation) : ''}`;
}
