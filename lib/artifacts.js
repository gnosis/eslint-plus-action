...
function downloadArtifact(client, target) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        console.log({ OWNER: constants_1.OWNER, REPO: constants_1.REPO, artifact_id: target.id });
...
function updateIssueState(client, data) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const name = utils_1.getIssueStateName(data);
        yield Promise.all([
            deleteArtifactByName(client, name, artifacts),
            saveArtifact(utils_1.getIssueStateName(data), JSON.stringify(Object.assign(Object.assign({}, data.persist), { workflow: undefined }))),
        ]);
    });
}
